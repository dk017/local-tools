...
impl PythonBridge {
    ...
    pub fn start(&self, app: &AppHandle) {
        ...
        tauri::async_runtime::spawn(async move {
            ...
            // SECURE: Pass VALIDATION_SERVICE_URL instead of LEMONSQUEEZY_API_KEY
            // The desktop app now calls your validation service instead of LemonSqueezy directly
            // This prevents API key extraction from the binary
            ...
            // Optional: Pass DEV_MOCK_LICENSE for development/testing
            if let Ok(mock_license) = std::env::var("DEV_MOCK_LICENSE") {
                sidecar_command = sidecar_command.env("DEV_MOCK_LICENSE", mock_license);
            }
