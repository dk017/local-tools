...
test.describe('Merge PDF Tool', () => {
  ...
  test('should merge two PDFs', async ({ page }) => {
    const pdf1 = fileLoader.getFixturePath('pdfs/document1.pdf');
    const pdf2 = fileLoader.getFixturePath('pdfs/document2.pdf');
  ...
  test('should merge multiple PDFs in order', async ({ page }) => {
    const pdfs = [
      fileLoader.getFixturePath('pdfs/document1.pdf'),
      fileLoader.getFixturePath('pdfs/document2.pdf'),
      fileLoader.getFixturePath('pdfs/document3.pdf'),
    ];
